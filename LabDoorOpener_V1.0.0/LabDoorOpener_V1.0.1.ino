...
void setup() {
  ...
  //Timer code
  FlexiTimer2::set(300, 1.0, _softRestart); // call every 5 1s "ticks"
  FlexiTimer2::start();
}
...
void loop() {
  ...
  content.toUpperCase();
  if (content.substring(1) == "1C 74 B2 65") //Joseph  change here the UID of the card/cards that you want to give access
  {
  ...
  else if(content.substring(1) == "E5 84 B1 65") //Mike
  {
    Serial.println("Authorized access");
    Serial.println();
    openClose();
  ...
  else if(content.substring(1) == "0E 15 2A 2B") //Amanda
  {
    Serial.println("Authorized access");
    Serial.println();
    openClose();
  ...
  else if(content.substring(1) == "F4 15 22 AA") //Mina
  {
    Serial.println("Authorized access");
    Serial.println();
    openClose();
