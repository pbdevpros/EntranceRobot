...
//2
const char* ssid = "sjccrac"; //WIFI Name, WeMo will only connect to a 2.4GHz network.
const char* password = "Rtl97!xy"; //WIFI Password

//defining the pin and setting up the "server"
//3
int relayPin = D1; // The Shield uses pin 1 for the relay
WiFiServer server(80);
IPAddress ip(192, 168, 1, 126); // where xx is the desired IP Address - most sets of numbers 
